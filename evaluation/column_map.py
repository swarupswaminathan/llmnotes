...
FILE_COLUMN_MAP: dict[str, list[str]] = {
    "grading_results_oms_standardized.xlsx": [
        ...
        "Oral Meds_adjudicated__standardized_current_oral_manual_review_required",
        "AI_Diagnosis__standardized_current_oral_json_manual_review_required",
    ...
    "grading_results_omcs_standardized.xlsx": [
        ...
        "Change in Oral Meds_adjudicated__standardized_change_oral_manual_review_required",
        "AI_Diagnosis__standardized_change_oral_json_manual_review_required",
    ...
    "grading_results_tms_standardized.xlsx": [
        ...
        "Topical Meds OS_adjudicated__standardized_current_os_manual_review_required",
        "Topical Meds OD_adjudicated__standardized_current_od_manual_review_required",
        "AI_Diagnosis__standardized_current_os_json_manual_review_required",
        "AI_Diagnosis__standardized_current_od_json_manual_review_required",
    ...
    "grading_results_tmcs_standardized.xlsx": [
        ...
        "Change in Topical Treatment OS_adjudicated__standardized_change_os_manual_review_required",
        "Change in Topical Treatment OD_adjudicated__standardized_change_od_manual_review_required",
        "AI_Diagnosis__standardized_change_os_json_manual_review_required",
        "AI_Diagnosis__standardized_change_od_json_manual_review_required",
